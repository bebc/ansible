...
class Ansible_hoc_api:
    ...
    def __init__(self):
        ...
        self.inventory = Inventory(loader=self.loader, variable_manager=self.variable_manager,  host_list='host.py')
    ...
    def run(self,module,command):
        ...
        play_source = {"name":"Ansible Ad-Hoc","hosts":"db","gather_facts":"no","tasks":[{"action":{"module":module,"args":command}}]}
