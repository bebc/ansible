...
play_source = {"name":"Ansible Ad-Hoc","hosts":"test","gather_facts":"no","tasks":[{"action":{"module":"setup","args":"filter=ansible_default_ipv4"}}]}
...
tqm.run(play)
result = json.loads(results_callback.data)
print type(result)
print result["192.168.73.130"]["ansible_facts"]["ansible_default_ipv4"]["address"]
